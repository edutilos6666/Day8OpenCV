...
public:
    ...
    {
        SourceWidget->setWindowTitle(QApplication::translate("SourceWidget", "SourceWidget", 0));
        lblSWFPS->setText(QApplication::translate("SourceWidget", "FPS:", 0));
        pbSW->setFormat(QApplication::translate("SourceWidget", " %v|%m", 0));
        btnSWChoose->setText(QApplication::translate("SourceWidget", "Choose Movie", 0));
    } // retranslateUi
