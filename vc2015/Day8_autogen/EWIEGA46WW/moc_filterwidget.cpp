...
QT_MOC_LITERAL(4, 31, 10), // "onNewImage"
QT_MOC_LITERAL(5, 42, 8) // "setModel"

    },
    "FilterWidget\0newImage\0\0cv::Mat\0"
    "onNewImage\0setModel"
};
...
void FilterWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (FilterWidget::*_t)(cv::Mat );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&FilterWidget::newImage)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void FilterWidget::newImage(cv::Mat _t1)
{
